...
class Main
{
  ...
  private
    static final List ALFABETO = Arrays.asList("abcdefghijklmnopqrstuvwyzABCDEFGHIJKLMNOPQRSTUVWYZ".split(""));
  private
    static final List NUMERO = Arrays.asList("1234567890".split(""));
  private
    static final List OPERACION = Arrays.asList("+*-/%^".split(""));
  private
    static final List ESPECIALES = Arrays.asList(".;:#<>=!&,|\"'".split(""));
  private
    static final List AGRUPACION = Arrays.asList("(){}[]".split(""));

    //Se coge todos los bloques y se dividen en caracteres, para empezar a identificar tokens
  public
    static void analizar(String bloque, int fila)
    {
        int columna = 1;
  ...
  public
    static String esSimbolo(String texto)
    {

        Hashtable<String, String> car_res = new Hashtable<String, String>();
        car_res.put("{", "token_llave_izq");
        car_res.put("}", "token_llave_der");
        car_res.put("#", "token_com");
        car_res.put("[", "token_cor_izq");
        car_res.put("]", "token_cor_der");
        car_res.put("(", "token_par_izq");
        car_res.put(")", "token_par_der");
        car_res.put(">", "token_mayor");
        car_res.put("<", "token_menor");
        car_res.put(">=", "token_mayor_igual");
        car_res.put("<=", "token_menor_igual");
        car_res.put("in", "token_in");
        car_res.put("==", "token_igual_num");
        car_res.put(".", "token_point");
        car_res.put("!=", "token_diff_num");
        car_res.put("&&", "token_and");
        car_res.put("||", "token_or");
        car_res.put("!", "token_not");
        car_res.put("+", "token_mas");
        car_res.put("-", "token_menos");
        car_res.put("*", "token_mul");
        car_res.put("/", "token_div");
        car_res.put("%", "token_mod");
        car_res.put("^", "token_pot");
        car_res.put("=", "token_eq");
        car_res.put(",", "token_comma");
  ...
  public
    static String esReservada(String texto)
    {
        switch (texto)
        {
        case "log":
  ...
  public
    static void imprimir(String token, int fila, int colum)
    {
