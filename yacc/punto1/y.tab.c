...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 9 "cal1.y" /* yacc.c:1646  */
    {printf("= %d\n",(yyvsp[0]));}
#line 1200 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 11 "cal1.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[-2]) + (yyvsp[0]); }
#line 1206 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 12 "cal1.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[-2]) - (yyvsp[0]); }
#line 1212 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 13 "cal1.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[-2]) * (yyvsp[0]); }
#line 1218 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 14 "cal1.y" /* yacc.c:1646  */
    {if ((yyvsp[0]) == 0)  yyerror("Error dividir entre cero");
								else
								(yyval) = (yyvsp[-2]) / (yyvsp[0]); }
